...
def process_dataset(dataset_root, 
    ...
    print(f"\n--- Processing subdataset: {dataset_root} ---")
    ...
    for fold in range(folds):
        ...
        train_csv = dataset_root / f"train{fold}.csv"
        val_csv = dataset_root / f"val{fold}.csv"
        ...
        train_files, train_labels = read_csv(train_csv, dataset_root)
        val_files, val_labels = read_csv(val_csv, dataset_root)
